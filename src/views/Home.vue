  ...
  <div class="home">
    ...
    <div class="main-bd">
      ...
      <div class="mp-wrap">
        ...
        <mp title="月销售完成度" :val="mounthSealPrecent" :percent="true"></mp>
        <mp title="有效店铺" :val="shops" :percent="false"></mp>
      </div>
    </div>
    <div class="main-nav">
  ...
  export default {
    ...
    created() {
      service.getUserProgress().then(res => {
        this.mounthSealPrecent = parseInt(res.data.mounthSealPrecent);
        console.log(res.data.totalShops,res.data.mounthSealPrecent);
